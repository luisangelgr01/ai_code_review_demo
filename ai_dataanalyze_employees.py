...
api_type = "azure"
api_base = os.getenv("AZURE_OPENAI_ENDPOINT_1")
api_version = os.getenv("API_VERSION_1")
api_key = os.getenv("AZURE_OPENAI_API_KEY_1")
deployment_name = os.getenv("DEPLOYMENT_NAME_1")
model_name = os.getenv("MODEL_NAME_1")
